...
import { db, type Ober, type Bedrijf } from '@/lib/firebase'
      ...
      <div className="w-full max-w-sm">
        ...
        {ober.verhaal && (
          <div className="bg-white border border-brand-100 rounded-2xl p-4 mb-6 text-center">
            ...
            <p className="text-gray-700 text-sm italic">"{ober.verhaal}"</p>
          </div>
        )}
        ...
        {/* Sterren + complimenten + boodschap — zichtbaar na bedragkeuze */}
